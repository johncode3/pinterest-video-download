...
## Shortcut
- You can also run the app with the provided `PinterestDownloader.bat` file, which will set up the virtual environment and start the server for you. Just double-click it!
- Or you can create a shortcut of the batch file on your desktop for easy access.